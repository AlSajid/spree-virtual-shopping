export default function CategoryList() {
    // const { featured } = useContext(AllContexts);

    return (
        <div className="lg:h-[360px] overflow-y-scroll bg-gray-100 rounded-lg border-gray-100 border-4 
              ...
              featured.categories?.map((category) =>
                <li key={category._id}>
                  <Link to={`products/${category.name}`}>
                    <div className="flex items-center px-3 border-b-2 border-white mx-1 my-2 hover:cursor-pointer
                         font-semibold
